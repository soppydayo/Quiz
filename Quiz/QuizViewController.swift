...
class QuizViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //------------------------ここから下にクイズを書く------------------------//
        quizArray.append(["そっぴーの好きな食べ物は？", "カレー", "オムライス", "シチュー", 1])
        quizArray.append(["そっぴーの最近の趣味は？", "サウナ", "キャンプ", "筋トレ", 2])
        quizArray.append(["そっぴーのあだ名の由来は？", "ギャル先生につけてもらった", "思いつき", "LiT!のために本気で考えた", 1])
        //------------------------ここから上にクイズを書く------------------------//
